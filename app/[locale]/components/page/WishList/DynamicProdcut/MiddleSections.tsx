...
بشكل تقريبي: سيتم تسليمه للشحن ضمن 3-4 أيام عمل  
        ...
        <button onClick={() => handleAddToCard(data._id)} className="w-full p-3 pb-5 text-white text-xl lg:text-xl bg-[#006496] hover:bg-[#004169]  rounded-md block mt-3 mx-auto">
          أضف إلى السلة
        </button>
      </div>
    </div>

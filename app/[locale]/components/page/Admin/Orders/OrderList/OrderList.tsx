    ...
    const columns: ColumnsType<any> = [
        {
            ...
            dataIndex: "userName",
            key: "userName",
            render:(_, record) => <a onClick={()=>{setOpenAllOrderOfUser(true) ;setUserId(record.userId)}}>{record.customerName}</a>,
        },
        {
            title: "الإسم المدخل",
            dataIndex: "userName",

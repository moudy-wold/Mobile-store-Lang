...
function Plans(props: any) {
  ...
  const handleChange = (e: any) => {
    ...
    if (type === "file") {
      setFormValuesForUpdate((prevValues: any) => ({
        ...prevValues,
        receipt: files[0],
      }));
    } else {
  ...
  const onFinish = async (e: any) => {
    ...
    if (selected == "") {
      notification.error({ message: t("please_choose_payment_method ") });
      ...
      try {
        ...
        notification.success({
          message: t("subscription_renewed_has_been_activated_successfully"),
        });
      ...
      return (
        <div key={index} className="py-12 px-3 lg:p-5">
          <div
            ...
            } px-6 pt-10 pb-5 mx-1 flex-col gap-5 relative
                `}
          >
            {/* Start Popular */}
            {item.feature && (
                ...
                <ul className="flex flex-col gap-4">
                  ...
                  <li className="flex items-center gap-2  w-fit cursor-pointer ">
                    ...
                    <span className="border-b-2 border-dotted border-gray-400 relative  ">
                      ...
                      {item.max_repair_service == "-1"
                        ? "open"
                        : item.max_repair_service}
                    </span>
                  </li>
                  <li className="flex items-center gap-2  w-fit cursor-pointer ">
                    <Image
  ...
  return (
    <div className="">
      ...
      <div
        className={`${
          Object.keys(props).length == 0 && "mt-20 mx-10 lg:mt-24 lg:mx-32 "
        }`}
      >
        {Object.keys(props).length == 0 && (
          <>
            ...
            <h1 className="mx-auto w-fit text-3xl mt-10 mb-0 lg:my-10">
              {" "}
              تجديد الإشتراك
            </h1>
          </>
        ...
        <h2>
          <button
            type="button"
            className={`${
              props.slidePlans ? "flex" : "hidden"
            } items-center justify-center p-3 my-10 rounded-lg  border-2 border-[#006496] bg-[#006496]  hover:bg-white font-semibold py-2 text-white  hover:text-[#006496]  hover:[&{sapn}]:text-[#006496] transition-all duration-150 ${
              props?.slidePlans ? " [&{sapn}]:!text-white  " : " "
            }  `}
            onClick={() => {
              setTimeout(() => {
                window.scrollTo({ top: 1600, behavior: "smooth" });
              }, 300);
              props?.setSlidePlans(!props?.slidePlans);
            }}
        ...
        <div
          ...
          className={`grid text-sm text-slate-600 overflow-hidden transition-all duration-300 ease-in-out ${
            Object.keys(props).length == 0
              ...
              : props.slidePlans && "grid-rows-[0fr] opacity-0"
          } `}
        >
                      ...
                      <div
                        ...
                        className={`hidden lg:block border-[3px]    ${
                          plane?.id == item.id
                            ? " border-[#006496] "
                            : "border-[#d5dfff]"
                        } px-6 pt-10 pb-5 flex-col gap-5 relative
                 `}
                      >
                        {/* Start Popular */}
                        {item?.feature && (
                ...
                {plane.plan_prices?.map((item: any, index: number) => (
                  ...
                  >
                    ...
                    >
                      <p
                        className={`${
                          selected == item.duration ? "text-white" : "textblack"
                        } `}
                      >
          ...
          {Object.keys(plane).length > 0 && (
            <>
              <form className="mt-5" onSubmit={onFinish}>
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mb-4 mt-4">
                          ...
                          >
                            <span
                              className={`${
                                !copiedName && copiedID == item.id && copied
                                  ? "bg-white"
                                  : "bg-gray-400"
                ...
                />
                <label className="mx-3">{t("You_can_upload_images_or_pdf_file")}</label>

...
import { DeleteProduct, GetAllOffresProducts, UpdateOfferProduct } from "@/app/[locale]/api/product";
import EditOffer from "../Category/CrudProducts/EditOffer/EditOffer";

...
const breadcrumbData = [{ title: "فحص الإيمي", url: "/phone", id: 1 }];
      ...
      <div className="border-2 border-gray-200 rounded-lg  flex justify-center py-20">
        ...
        >
          <div className="w-full border-2 border-gray-200 rounded-lg px-1 flex items-center justify-center ">
            <input
              type="number"
              placeholder="يرجى كتابة رقم الإيمي"
              className="w-96  p-3 text-xl outline-none"
            />
            <button
              type="submit"
              className={`bg-[#4678e9] rounded-md py-2 px-5 text-white text-xl w-44  text-center transition-all duration-200 ${
